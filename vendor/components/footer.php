<footer>
    <div class="top_footer">
        <div class="footer_left">
            ...
            <div class="img_footer_left">
                <a href=""><img src="vendor/img/icons/instagram (2).png" alt=""></a>
                <a href=""><img src="vendor/img/icons/facebook 2.png" alt=""></a>
                <a href=""><img src="vendor/img/icons/vk 1.png" alt=""></a>
                <a href=""><img src="vendor/img/icons/whatsappWhite.png" alt=""></a>
                <a href=""><img class="img_footer_left_end" src="vendor/img/icons/TelegramWhite.png" alt=""></a>
            </div>
        </div>
        <div class="footer_right">
            ...
            <div class="for_buyer">
                ...
                <a href="info_order.php">
                    <p>Как сделать заказ</p>
                </a>
                <a href="info_delivery.php">
                    <p>Доставка и оплата</p>
                </a>
                <a href="info_refund.php">
                    <p>Возврат</p>
                </a>
                <a href="info_questions.php">
    ...
    <div class="bottom_footer">
        ...
        <img src="vendor/img/icons/mastercard.png" alt="">
        <img src="vendor/img/icons/visa.png" alt="">
        <img src="vendor/img/icons/мир.png" alt="">
    </div>
</footer>
